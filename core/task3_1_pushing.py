...
def solution():
    finalTargetPos = np.array([0.7, 0.00, 1])
    # startPosition = np.array([0.33, 0, 1.0])
    startPosition = np.array([0.1, 0,1])

    endEffector1 = 'LARM_JOINT5'
    endEffector2 = 'RARM_JOINT5'

    sim.moveEndEffectorToPosition(endEffector1,[0.18, 0, 1],[0.7, 0.00, 1],[0.7, 0.00, 1],spd1=2, spd2=2,spd3=2)
